...
void createKnfFormulaLeft(knfFormula * formulaElement)
{
    ...
    formulaElement -> subR = subL_copy -> subR;

    formulaElement -> next = (knfFormula*) malloc(sizeof(knfFormula));
    if(subL_copy -> next != NULL)
    {
        formulaElement -> next = subL_copy -> next;
    }
...
void createKnfFormulaRight(knfFormula * formulaElement)
{
    ...
    /* take subR formulas one level higher */
    formulaElement -> next = (knfFormula*) malloc(sizeof(knfFormula));
    if(formulaElement -> subL -> subL != NULL && formulaElement -> subL -> subR != NULL)
    {
        formulaElement -> subL = formulaElement -> subL -> subL;
        formulaElement -> subR = subL_copy -> subR;
    ...
    {
        formulaElement -> subL = subL_copy;
        formulaElement -> subR = NULL;
    }
